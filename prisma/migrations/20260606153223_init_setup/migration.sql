-- CreateEnum
CREATE TYPE IF NOT EXISTS "WorkspaceRole" AS ENUM ('DIRECTOR', 'ACCOUNTANT', 'EMPLOYEE');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "PersonType" AS ENUM ('DIRECTOR', 'ACCOUNTANT', 'EMPLOYEE', 'CONTRACTOR', 'CLIENT_CONTACT');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "CategoryType" AS ENUM ('INCOME', 'EXPENSE');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "GstTreatment" AS ENUM ('GST_INCLUDED', 'GST_FREE', 'NO_GST_OVERSEAS', 'MANUAL_OVERRIDE');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "BasTreatment" AS ENUM ('GST_COLLECTED', 'GST_PAID', 'PAYROLL', 'NONE');

-- CreateEnum
CREATE TYPE IF NOT EXISTS "BasFrequency" AS ENUM ('QUARTERLY', 'MONTHLY');
